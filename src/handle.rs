...
/// # use pcp::*;
/// # let client_ip = Ipv4Addr::new(192, 168, 1, 101);
/// # let server_ip = Ipv4Addr::new(192, 168, 1, 1);
/// // Start the PCP client service
/// let mut handle = Client::<Ipv4Addr>::start(client_ip, server_ip).unwrap();
///
...
/// handle.request(1, map, RequestKind::Repeat(0));
/// ```
...
impl<Ip: IpAddress> Handle<Ip> {
    ...
    pub fn wait(&mut self) -> Option<ClientEvent<Ip>> {
